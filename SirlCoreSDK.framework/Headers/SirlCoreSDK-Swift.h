...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SirlCoreSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AisleRegions (SWIFT_EXTENSION(SirlCoreSDK))
...
SWIFT_CLASS("_TtC11SirlCoreSDK10NodeConfig")
...
@interface NodeConfig (SWIFT_EXTENSION(SirlCoreSDK))
@property (nonatomic) int32_t mlId;
...
SWIFT_CLASS("_TtC11SirlCoreSDK15NodeConfigTable")
...
@interface NodeConfigTable (SWIFT_EXTENSION(SirlCoreSDK))
...
SWIFT_CLASS("_TtC11SirlCoreSDK4PIPS")
@interface PIPS : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("SessionToken")
...
@interface SessionToken (SWIFT_EXTENSION(SirlCoreSDK))
...
@interface Settings (SWIFT_EXTENSION(SirlCoreSDK))
...
SWIFT_CLASS("_TtC11SirlCoreSDK14SirlBLEAdapter")
...
@interface SirlBLEAdapter (SWIFT_EXTENSION(SirlCoreSDK)) <CLLocationManagerDelegate>
...
@interface SirlBLEAdapter (SWIFT_EXTENSION(SirlCoreSDK)) <CBCentralManagerDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
@end


SWIFT_CLASS("_TtC11SirlCoreSDK13SirlBLEPacket")
...
SWIFT_CLASS("_TtC11SirlCoreSDK8SirlCore")
...
SWIFT_CLASS("_TtC11SirlCoreSDK13SirlDataCache")
@interface SirlDataCache : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("TripData")
@interface TripData : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface TripData (SWIFT_EXTENSION(SirlCoreSDK))
