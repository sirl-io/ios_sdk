...
#ifndef SIRLCORE_SWIFT_H
#define SIRLCORE_SWIFT_H
...
@property (nonatomic) BOOL measured;
@property (nonatomic) int32_t generation;
...
@property (nonatomic) BOOL autoWakeup;
...
SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SirlBLEAdapter (SWIFT_EXTENSION(SIRLCore)) <CBPeripheralManagerDelegate>
...
- (void)setTestLocationWithType:(NSString * _Nonnull)type;
...
- (void)didStartFindingNearbySite;
- (void)didFoundNearbySite:(BOOL)found;
...
- (double)getDistance2DWithPoint:(SirlLocation * _Nonnull)point SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
