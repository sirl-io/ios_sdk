...
SWIFT_CLASS_NAMED("NodeConfigTable")
...
- (void)didReceiveSessionTokenWithToken:(NSString * _Nonnull)token;
@end
...
SWIFT_CLASS("_TtC8SIRLCore12SirlDataBase") SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface SirlDataBase : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
